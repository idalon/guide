---
description: Rubico / Perigale / Zenith
---
...
We highly recommended building Zenith, however if you don't have it yet you can use a Sniper Rifle like the ones below:

## &#x20;Perigale or Rubico Prime

![Same build for both sniper rifles](<../../.gitbook/assets/image (16)>)

{% hint style="info" %}
**Perigale** can be [farmed](https://wiki.warframe.com/w/Perigale#Acquisition) and is relatively easy to get\
**Rubico Prime** can be traded for, [**WF.market**](https://warframe.market/items/rubico_prime_set?type=sell)
{% endhint %}
