...
* What follows depends on the Harry spawn
{% endcolumn %}

{% column width="25%" %}
<div align="left" data-with-frame="true"><figure><img src="https://1960884447-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FMnWMWMKLrFw5Len33GHR%2Fuploads%2FMCiRkT0HRMh99ZMWToaE%2Funknown.png?alt=media&#x26;token=bc3d3e2f-6b60-440e-90ea-e24a5114608f" alt=""><figcaption></figcaption></figure></div>
{% endcolumn %}
{% endcolumns %}

{% hint style="info" %}
Alternatively, you can time those 9 seconds by different means, like using a clock or a stopwatch
{% endhint %}
...
* Make sure the lures have TP'd back with you
